...
def _clean_topic_description(value: Any) -> str | None:
    text = _clean_html_text(value)
    if not text:
        return None

    replacements = [
        ("Specific Challenge :", "Specific Challenge:"),
        ("Expected Impact :", "Expected Impact:"),
        ("ExpectedOutcome :", "Expected Outcome:"),
        ("Scope :", "Scope:"),
        ("Cross-cutting Priorities :", "Cross-cutting Priorities:"),
    ]
...
def _normalize_records(records: list[dict[str, Any]]) -> pd.DataFrame:
    ...
    for rec in records:
        ...
        description = _clean_topic_description(raw_description)
        ...
        normalized_rows.append(
            {
                ...
                "description_raw_html": _safe_str(raw_description),
